...
export const PlanFinder = () => {
  ...
  return (
    <Card className="shadow-2xl border-primary/20 border w-full max-w-md">
      <CardHeader>
          ...
          <Popover open={destinationOpen} onOpenChange={setDestinationOpen}>
            <PopoverTrigger asChild>
              <Button
                ...
                className="w-full justify-between h-12 text-base text-muted-foreground hover:bg-white"
              >
          ...
          <Popover open={dateOpen} onOpenChange={setDateOpen}>
            <PopoverTrigger asChild>
              <Button
                ...
                variant={"outline"}
                className={cn(
                  "w-full justify-between text-left font-normal h-12 text-base text-muted-foreground hover:bg-white",
